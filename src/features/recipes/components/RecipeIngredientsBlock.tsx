...
type Props = { recipe: Recipe; products: Product[]; productsLoading: boolean; canManage: boolean; editing: boolean; blocked: boolean; onEdit: () => void; onCancel: () => void; onSave: (patch: RecipeBlockPatch) => Promise<void>; servings: number; onServingsChange?: (servings: number) => void }

export function RecipeIngredientsBlock({ recipe, products, productsLoading, canManage, editing, blocked, onEdit, onCancel, onSave, servings, onServingsChange }: Props) {
