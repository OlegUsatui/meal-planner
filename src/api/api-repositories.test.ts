...
describe('API repository contracts', () => {
  ...
  it('uses REST verbs for meal plan and shopping list operations', async () => {
    ...
    await mealPlan.move('entry-1', '2026-08-16', 'dinner')
    ...
    expect(client.put).toHaveBeenCalledWith('/api/meal-plan/move', { entryId: 'entry-1', targetDate: '2026-08-16', targetSlot: 'dinner' })
