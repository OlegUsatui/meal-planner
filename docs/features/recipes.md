...
- 3–4 column photo card grid; optional archived toggle is secondary. Cards use the canonical 4:3 photo frame and a local illustrated fallback when a recipe photo is missing.
